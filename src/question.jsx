...
export const questions_mbti = [
  ...
  { question: "13 감정보다는 이성을 따르는 편이다.", YES: "T", NO: "F" },
  {
    question:
  ...
  { question: "16 단체 활동에 참여하는 일을 즐긴다.", YES: "E", NO: "I" },
  {
  ...
  //   NO: "I",
  // },
  // { question: "27 감정이 매우 빠르게 변하곤 한다.", YES: "T", NO: "F" },
  // {
  ...
  // {
  //   question:
  //     "36 혼자만의 시간을 보내기보다 는 즐거운 파티와 행사로 일주일의 피로를 푸는 편이다.",
  //   YES: "E",
  //   NO: "I",
  // },
  // { question: "37 미술관에 가는 일을 좋아한다.", YES: "S", NO: "N" },
  // {
  //   question: "38 다른 사람의 감정을 이해하기 힘들 때가 많다.",
  //   YES: "T",
  //   NO: "F",
  // },
  // { question: "39 매일 할 일을 계획하는 일을 좋아한다.", YES: "J", NO: "P" },
  // { question: "40 불안함을 느낄 때가 거의 없다.", YES: "S", NO: "N" },
  // {
  ...
  //   NO: "P",
  // },
  // { question: "45 오래전의 실수를 후회할 때가 많다.", YES: "S", NO: "N" },
  // {
  ...
  // },
  // {
  //   question: "47 감 정을 조절하기보다는 감정에 휘둘리는 편이다.",
  //   YES: "T",
  //   NO: "F",
  // },
  // {
  ...
  //   NO: "F",
  // },
  // { question: "59 마감 기한을 지키기가 힘들다.", YES: "J", NO: "P" },
  // {
